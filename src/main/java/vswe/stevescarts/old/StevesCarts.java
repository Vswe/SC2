...
import vswe.stevescarts.old.Helpers.EntityEasterEgg;
import vswe.stevescarts.old.Helpers.GeneratedInfo;
import vswe.stevescarts.old.Helpers.GiftItem;
import vswe.stevescarts.old.Helpers.TradeHandler;
import vswe.stevescarts.old.Helpers.WoodFuelHandler;
import vswe.stevescarts.old.Items.*;
import vswe.stevescarts.old.Listeners.ChunkListener;
import vswe.stevescarts.old.Listeners.MobDeathListener;
import vswe.stevescarts.old.Listeners.MobInteractListener;
import vswe.stevescarts.old.Listeners.OverlayRenderer;
import vswe.stevescarts.old.Listeners.PlayerSleepListener;
import vswe.stevescarts.old.Listeners.TicketListener;
...
public class StevesCarts {
	...
	public void preInit(FMLPreInitializationEvent event) {
        ...
        vswe.stevescarts.Blocks.ModBlocks.init();
	...
	public void load(FMLInitializationEvent evt) {
		...
		tabsSC2Blocks.setIcon(new ItemStack(vswe.stevescarts.Blocks.ModBlocks.CART_ASSEMBLER.getBlock(), 1));

		TileEntityCargo.loadSelectionSettings();

        ModItems.addRecipes();
        vswe.stevescarts.Blocks.ModBlocks.addRecipes();
	}
