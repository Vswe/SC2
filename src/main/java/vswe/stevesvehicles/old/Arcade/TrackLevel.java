...
public class TrackLevel {
	...
	@SideOnly(Side.CLIENT)
	public static boolean saveMap(String name, int playerX, int playerY, DIRECTION playerDir, int itemX, int itemY, ArrayList<Track> tracks) {
		try {
	...
	@SideOnly(Side.CLIENT)
	public static String saveMapToString(String name, int playerX, int playerY, DIRECTION playerDir, int itemX, int itemY, ArrayList<Track> tracks) {
		try {
			byte[] bytes = saveMapData(name, playerX, playerY, playerDir, itemX, itemY, tracks);
	...
	@SideOnly(Side.CLIENT)
	public static byte[] saveMapData(String name, int playerX, int playerY, DIRECTION playerDir, int itemX, int itemY, ArrayList<Track> tracks) throws IOException {
